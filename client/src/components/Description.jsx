            ...
            <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
                ...
                <div className=''>
                    ...
                    <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI
                        ...
                        imagery, our tool transform your text into eye-catching images
                        with just a few clicks. Imagine it, describe it, and watch it
                    ...
                    <p className='text-gray-600' >
                        ...
                        even concepts that don't yet exist can be visualizes effortlessly.
