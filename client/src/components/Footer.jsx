...
// const Footer = () => {
//     return (
//         <div className='flex items-center justify-between gap-4 py-3 mt-29'>
//             <img src={assets.logo} alt="" width={150} />

//             <p className='flex-1 border-l border-gray-400 p1-4 text-sm
//             text-gray-500 max-sm:hidden'>Copyright @Sajan.dev | All rights reserved.</p>
...
const Footer = () => {
    return (
        ...
        text-gray-500 max-sm:hidden"
            >
                Copyright © Sajan.dev | All rights reserved.
            </p>
